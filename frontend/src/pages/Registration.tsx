...
const Registration: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://birthdaywishermain.onrender.com/api/auth/register", {
        method: "POST",
  ...
  const handleOtpSubmit = async (otp: string) => {
    ...
    try {
      setLoading(true);
      const res = await fetch("https://birthdaywishermain.onrender.com/api/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
